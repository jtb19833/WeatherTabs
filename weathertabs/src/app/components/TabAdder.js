...
export default function TabAdder () {
    ...
    return (
        <div className="flex flex-col items-center self-center p-10 m-10 w-full max-w-[1200px] bg-indigo-300 rounded-3xl gap-5">
            ...
            <div className="flex flex-col bg-inherit items-center justify-space-between self-center w-fill" onSubmit={handlesubmit}>
                ...
                <div className="flex flex-row bg-inherit text-white justify-space-between items-center self-center min-w-500 min-h-fit gap-10">
                    <button type="submit" className="font-bold text-lg bg-blue-600 text-white py-2 px-4 rounded-lg">Add Tab</button>
